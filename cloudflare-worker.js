...
Андрей — чемпион мира по пауэрлифтингу с медицинским образованием, ведёт клиентов только онлайн.
...
- Если человеку нужна персональная программа, план питания или разбор анализов — предлагаешь написать Андрею напрямую: WhatsApp +1 825 819-9441 или Telegram +7 995 272-3614. Тарифы — в разделе «Тарифы» на главной странице.
